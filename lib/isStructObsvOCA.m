function [isStructObsv_flag, necessity_flag, sufficiency_flag]=isStructObsvOCA(G_effort,plotBG,node_2_XData,node_2_YData)
...
G_inverted_causal = BG_CA(G_sensor_connection,'Procedure','OCA-D');

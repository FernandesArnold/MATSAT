function G = BG_sensor_locations_all(G)
%Add ZERO and ONE junctions at all locations, including sources
SE = 1;
SF = 2;
C = 3;
I = 4;
...
single_port_nodes = [C_nodes;I_nodes;R_nodes;SE_nodes;SF_nodes];
